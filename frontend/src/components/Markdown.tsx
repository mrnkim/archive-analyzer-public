...
export function Markdown({ children, className = "" }: Props) {
  ...
  return (
    <div
      className={
        "text-foreground-body leading-relaxed " +
        ...
        "[&_table]:my-2 [&_table]:text-xs [&_th]:font-semibold [&_th]:text-left [&_th]:px-2 [&_th]:py-1 [&_td]:px-2 [&_td]:py-1 [&_th]:border-b [&_th]:border-border-secondary " +
        "[&_a]:text-tl-embed-green [&_a]:underline " +
        className
      }
    >
